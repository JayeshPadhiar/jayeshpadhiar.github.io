export default function Skills() {
    ...
    const styles = {
        ...
        skill: "text-sm border-1 border-foreground/10 rounded-full px-4 py-1 w-fit transition-all duration-300 cursor-default",
    ...
    return (
        <section id="skills" className={styles.container}>
            ...
            <div className="grid grid-cols-3 gap-y-16 gap-x-8 w-full">
